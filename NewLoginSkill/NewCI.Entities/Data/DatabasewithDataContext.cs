...
namespace NewCI.Entities.Data;

public partial class DatabasewithDataContext : DbContext
{
    public DatabasewithDataContext()
    {
    }

    public DatabasewithDataContext(DbContextOptions<DatabasewithDataContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=PCA167\\SQL2017;User=sa;Password=Tatva@123;Database=DatabasewithData;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Admin>(entity =>
        {
            entity.HasKey(e => e.AdminId).HasName("PK__admin__43AA4141C41979BD");
        ...
        {
            entity.HasKey(e => e.BannerId).HasName("PK__banner__10373C347804CAAE");
        ...
        {
            entity.HasKey(e => e.CityId).HasName("PK__city__031491A80025B6E0");
            ...
            entity.HasOne(d => d.Country).WithMany(p => p.Cities)
                ...
                .HasConstraintName("FK__city__country_id__3E1D39E1");
        });

        modelBuilder.Entity<CmsPage>(entity =>
        {
            entity.HasKey(e => e.CmsPageId).HasName("PK__cms_page__B46D5B526F0004F9");
        ...
        {
            entity.HasKey(e => e.CommentId).HasName("PK__comment__E7957687D9D4738E");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.Comments)
                ...
                .HasConstraintName("FK__comment__mission__40058253");

            entity.HasOne(d => d.User).WithMany(p => p.Comments)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__comment__user_id__3F115E1A");
        });

        modelBuilder.Entity<ContactU>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__ContactU__3214EC07CAAB7185");
        ...
        {
            entity.HasKey(e => e.CountryId).HasName("PK__country__7E8CD05568389E44");
        ...
        {
            entity.HasKey(e => e.FavouriteMissionId).HasName("PK__favourit__94E4D8CA3F28F233");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.FavouriteMissions)
                .HasForeignKey(d => d.MissionId)
                .HasConstraintName("FK__favourite__missi__41EDCAC5");
        ...
        {
            entity.HasKey(e => e.GoalMissionId).HasName("PK__goal_mis__358E02C7DAF8727E");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.GoalMissions)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__goal_miss__missi__42E1EEFE");
        });

        modelBuilder.Entity<Mission>(entity =>
        {
            entity.HasKey(e => e.MissionId).HasName("PK__mission__B5419AB2B6CB5DDC");
            ...
            entity.HasOne(d => d.City).WithMany(p => p.Missions)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission__city_id__44CA3770");

            entity.HasOne(d => d.Country).WithMany(p => p.Missions)
                .HasForeignKey(d => d.CountryId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission__country__45BE5BA9");

            entity.HasOne(d => d.MissionTheme).WithMany(p => p.Missions)
                .HasForeignKey(d => d.MissionThemeId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission__mission__43D61337");
        });

        modelBuilder.Entity<MissionApplication>(entity =>
        {
            entity.HasKey(e => e.MissionApplicationId).HasName("PK__mission___DF92838A1A78C5CA");
            ...
            entity.HasOne(d => d.User).WithMany(p => p.MissionApplications)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission_a__user___47A6A41B");
        });

        modelBuilder.Entity<MissionDocument>(entity =>
        {
            entity.HasKey(e => e.MissionDocumentId).HasName("PK__mission___E80E0CC8140F3915");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.MissionDocuments)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission_d__missi__489AC854");
        });

        modelBuilder.Entity<MissionInvite>(entity =>
        {
            entity.HasKey(e => e.MissionInviteId).HasName("PK__mission___A97ED158F254F9FE");
        ...
        {
            entity.HasKey(e => e.MissionMediaId).HasName("PK__mission___848A78E8A3ED0C8F");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.MissionMedia)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission_m__missi__4C6B5938");
        });

        modelBuilder.Entity<MissionRating>(entity =>
        {
            entity.HasKey(e => e.MissionRatingId).HasName("PK__mission___320E51728C2C9FAA");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.MissionRatings)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission_r__missi__4E53A1AA");

            entity.HasOne(d => d.User).WithMany(p => p.MissionRatings)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission_r__user___4D5F7D71");
        });

        modelBuilder.Entity<MissionSkill>(entity =>
        {
            entity.HasKey(e => e.MissionSkillId).HasName("PK__mission___82712008878CC7C0");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.MissionSkills)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission_s__missi__503BEA1C");

            entity.HasOne(d => d.Skill).WithMany(p => p.MissionSkills)
                .HasForeignKey(d => d.SkillId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission_s__skill__4F47C5E3");
        });

        modelBuilder.Entity<MissionTheme>(entity =>
        {
            entity.HasKey(e => e.MissionThemeId).HasName("PK__mission___4925C5ACAAAAF0FA");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__password__3213E83FD0707D77");
        ...
        {
            entity.HasKey(e => e.SkillId).HasName("PK__skill__FBBA8379EDE3A687");
        ...
        {
            entity.HasKey(e => e.StoryId).HasName("PK__story__66339C56726C9E67");
        ...
        {
            entity.HasKey(e => e.StoryInviteId).HasName("PK__story_in__044978671E6C734F");
            ...
            entity.HasOne(d => d.FromUser).WithMany(p => p.StoryInviteFromUsers)
                .HasForeignKey(d => d.FromUserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__story_inv__from___540C7B00");

            entity.HasOne(d => d.Story).WithMany(p => p.StoryInvites)
                .HasForeignKey(d => d.StoryId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__story_inv__story__531856C7");

            entity.HasOne(d => d.ToUser).WithMany(p => p.StoryInviteToUsers)
                .HasForeignKey(d => d.ToUserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__story_inv__to_us__55009F39");
        });

        modelBuilder.Entity<StoryMedium>(entity =>
        {
            entity.HasKey(e => e.StoryMediaId).HasName("PK__story_me__29BD053CA50ED6C7");
        ...
        {
            entity.HasKey(e => e.TimesheetId).HasName("PK__timeshee__7BBF50680F790257");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.Timesheets)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__timesheet__missi__57DD0BE4");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__user__B9BE370FCE955B5B");
            ...
            entity.HasOne(d => d.City).WithMany(p => p.Users)
                .HasForeignKey(d => d.CityId)
                .HasConstraintName("FK__user__city_id__58D1301D");

            entity.HasOne(d => d.Country).WithMany(p => p.Users)
                .HasForeignKey(d => d.CountryId)
                .HasConstraintName("FK__user__country_id__59C55456");
        });

        modelBuilder.Entity<UserSkill>(entity =>
        {
            entity.HasKey(e => e.UserSkillId).HasName("PK__user_ski__FD3B576B19DEDF74");
